...
class ImageConverter:
    def __init__(self):
        ...
        self.rgb_sub = None
        self.depth_sub = None
        self.detect_sub = rospy.Subscriber("/tb3_0/detect_status", String, self.detect_status_callback)
    ...
    def subscribe_to_topics(self):
        if self.rgb_sub is None:
            self.rgb_sub = rospy.Subscriber("/camera_tb3_0/color/image_raw/compressed", Image, self.rgb_callback)
        if self.depth_sub is None:
            self.depth_sub = rospy.Subscriber("/camera_tb3_0/aligned_depth_to_color/image_raw", Image, self.depth_callback)
...
def camera_to_base(point_wrt_camera_with_z):
    ...
    point_world_in_meters[2] = point_world_in_meters[2] + 0.03
...
def main():
    ...
    pub = rospy.Publisher('tb3_0/object_world_coordinates', ObjectWorldCoordinates_RobotID, queue_size=10)
